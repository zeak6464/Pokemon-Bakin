...
namespace Bakin
{
    public class Digievo : BakinObject
    {
        ...
        private void ChoiseSelection()
        {
            ...
            if (phase == 0) Graphics.DrawString(0, "Who do you want to evolve?", new Microsoft.Xna.Framework.Vector2(500, 500), Microsoft.Xna.Framework.Color.White, 2);
            if (phase != 0) Graphics.DrawString(0, "Choose a evolution", new Microsoft.Xna.Framework.Vector2(500, 500), Microsoft.Xna.Framework.Color.White, 2);
              ...
              //  mapChr.setPosition(mapScene.hero.pos);
                ...
                bool Func()
                {
                    ...
                    else if (wait != 999)
                    {
                        ...
                        _effect.playMotion("front", 0.2f, false, true);
                    }

                    if (_effect.isChangeMotionAvailable())
                    {
                        _effect.playMotion("front", 0.4f, false, false);
                    }
