...
namespace Yukar.Battle
{
    ...
    class CommandTargetSelecter
    {
        ...
        // Pokemon-style: Expose target list for displaying all available targets
        public List<BattleCharacterBase> GetTargetList() { return targetList; }
        public bool IsInTargetList(BattleCharacterBase character) { return targetList.Contains(character); }
